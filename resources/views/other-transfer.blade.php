      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-3">
            ...
            <p class="text-white mt-0 mb-7">Other Banks Transfer.  Send Money to Family and Friends, Enjoy Swift and Safe transfer service.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          ...
          <div class="card">
            ...
            <form method="POST" action="/other-transfer-now" class="pt-3">
                    @csrf
                <div class="pl-lg-6">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Select Bank</label>
                        <select class ="form-control selectpicker" name="bank_name" id=""data-live-search="true" class="form-control">
