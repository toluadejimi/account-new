        ...
        <div class="col-xl-8 order-xl-1">
          ...
          <div class="card">
            ...
            @if ($errors->any())
                ...
                <h6 class="heading-small text-muted mb-4">Send us a message</h6>
            <form method="POST" action="/contact-now" class="pt-3">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" required name="subject" id="subject" class="form-control" placeholder="Enter Subject">
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Enter Message</label>
                        <textarea type="textarea" required name="message" id="message" class="form-control" placeholder="Start Typing....."></textarea>
                      </div>
                    </div>
